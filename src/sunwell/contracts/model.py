...
Extracted from sunwell.models.core.protocol per the Contracts Layer plan.
...
class Tool:
    ...
    Note: The ``from_skill`` classmethod lives in
    ``sunwell.models.core.protocol`` to avoid importing planning
    types here.
    """
