...
class NotificationStore:
    ...
    def get_today(self) -> list[NotificationRecord]:
        ...
        records = [
            r for r in self._read_all() if datetime.fromisoformat(r.timestamp).date() == today
        ]
        records.reverse()
        return records
    ...
    def get_by_type(
        ...
        """
        records = [r for r in self._read_all() if r.type == notification_type.value]
        records.reverse()
        return records[:limit]
    ...
    def get_since(self, since: datetime) -> list[NotificationRecord]:
        ...
        """
        records = [r for r in self._read_all() if datetime.fromisoformat(r.timestamp) >= since]
        records.reverse()
        return records
