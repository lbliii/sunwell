...
The legacy default preserves full backward compatibility -- existing
projects continue to work without any configuration change.

See also: Out-of-Tree State Isolation plan.
"""
