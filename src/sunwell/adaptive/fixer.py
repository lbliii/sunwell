...
from sunwell.adaptive.signals import ErrorSignals, classify_error
from sunwell.adaptive.validation import Artifact, ValidationError
...
class StaticAnalysisFixer:
    ...
    async def fix_at_gate(
        ...
        Yields:
            AgentEvent for fix progress
        """
        from sunwell.adaptive.toolchain import PYTHON_TOOLCHAIN, ToolchainRunner
