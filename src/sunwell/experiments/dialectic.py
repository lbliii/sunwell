...
Be specific and concrete. 2-3 paragraphs max."""
    ...
    # Get thesis and antithesis in parallel (independent perspectives)
    thesis_response, antithesis_response = await asyncio.gather(
        model.generate(
            thesis_prompt,
...
Bullet points, be specific."""
    ...
    # Get do and dont in parallel (independent perspectives)
    do_response, dont_response = await asyncio.gather(
        model.generate(
            do_prompt,
