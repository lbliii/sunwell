...
Example:
    >>> from sunwell.experiments import speculative_discover
    >>>
...
if TYPE_CHECKING:
    ...
    from sunwell.prism.artifacts import ArtifactGraph
...
async def speculative_discover(
    ...
    """
    from sunwell.prism.artifacts import ArtifactLimits
