...
Example:
    >>> from sunwell.experiments.cellular import cellular_discover
    >>>
...
if TYPE_CHECKING:
    ...
    from sunwell.prism.artifacts import ArtifactGraph, ArtifactSpec
...
async def _fire_cell(
    ...
    from sunwell.prism.artifacts import ArtifactSpec
...
async def cellular_vs_monolithic(
    ...
    from sunwell.prism.planners.artifact import ArtifactPlanner
