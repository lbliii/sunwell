...
from sunwell.simulacrum.spatial import SpatialQuery
from sunwell.simulacrum.facets import FacetQuery, DiataxisType, PersonaType
from sunwell.simulacrum.topology import RelationType
...
class UnifiedContext:
    ...
    def to_messages(self) -> list[dict]:
        ...
        if self.memory_nodes:
            system_parts.append("\n\n## Relevant Memory")
            for node, score in self.memory_nodes[:10]:  # Top 10
